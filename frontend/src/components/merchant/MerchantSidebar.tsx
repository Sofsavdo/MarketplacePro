  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-blue-900 to-blue-800 shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-blue-700">
          ...
          <button
            onClick={() => setSidebarOpen(false)}
            className="lg:hidden p-2 rounded-md text-blue-400 hover:text-white hover:bg-blue-700"
          >
        ...
        <div className="absolute bottom-20 left-0 right-0 px-6">
          <div className="bg-blue-800 rounded-lg p-4">
            <h4 className="text-sm font-medium text-blue-300 mb-3">Do'kon holati</h4>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs text-blue-400">Bugungi sotuvlar</span>
                <span className="text-xs text-green-400 font-medium">12</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs text-blue-400">Daromad</span>
                <span className="text-xs text-yellow-400 font-medium">$2.5M</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs text-blue-400">Mahsulotlar</span>
